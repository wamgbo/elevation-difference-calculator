...
def get_C(dh_list):
    WH_mm,C=_Allowable_Misclosure(dh_list),
    return C
def get_WH_mm(dh_list):
    WH_mm,temp=_Allowable_Misclosure(dh_list)
    return WH_mm
def _Allowable_Misclosure(dH_list):
    global K
    # 修正: 先加總再乘 1000 換算成 mm
